import { buildPath, escapeKey } from "./path.js";
...
function diffValue(path, a, b, opts, ops) {
    if (equal(a, b))
        return;
...
function diffObject(path, a, b, opts, ops) {
 ...
 */
function diffKeyed(path, a, b, keyField, opts, ops) {
    const keyOf = (el) => {
        if (el === null || typeof el !== 'object')
            return undefined;
        const raw = el[keyField];
