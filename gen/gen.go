...
//
// Generated diff code iterates maps through this rather than ranging over them
// directly, so that diffing the same pair of values twice produces the same
// operations in the same order. Go randomises map iteration, and a patch whose
// operation order varies between runs cannot be logged, cached, compared or
// signed.
