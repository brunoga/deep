...
func (t *Alpha) applyOperation(op deep.Operation, logger *slog.Logger) (bool, error) {
	if op.If != nil {
...
func (t *Alpha) evaluateCondition(c condition.Condition) (bool, error) {
	switch c.Op {
	case "and":
